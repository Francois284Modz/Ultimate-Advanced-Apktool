...
#Region " Private Sub"
    ...
    Private Sub GetStatus()
        Try
            ...
            File.WriteAllBytes(My.Computer.FileSystem.SpecialDirectories.Temp & "\SignCheck.nga", My.Resources.UAA.Sign)
            If File.Exists(My.Computer.FileSystem.SpecialDirectories.Temp & "\Check.nga") Then
                If System.Text.Encoding.Default.GetString(File.ReadAllBytes(My.Computer.FileSystem.SpecialDirectories.Temp & "\Check.nga")) = System.Text.Encoding.Default.GetString(File.ReadAllBytes(My.Computer.FileSystem.SpecialDirectories.Temp & "\SignCheck.nga")) Then
    ...
    Private Sub DAFE()
        ...
        Try
            ...
            If args.Length > 1 Then
                ...
                Else
                    MsgBox("This is not a '.apk' file", MsgBoxStyle.Information, "")
...
#Region " Form Load "
    Private Sub Form1_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        If IsAdministrator() = True Then
            ...
            Me.Label40.ForeColor = Color.Green
...
#Region " Drag & Drop "
    ...
    Private Sub TextBox2_DragDrop(sender As System.Object, e As System.Windows.Forms.DragEventArgs) Handles TextBox2.DragDrop
        ...
        Else
            MsgBox("This is not decompile .apk folder.", MsgBoxStyle.Information, "Info")
        End If
    End Sub
...
#Region "Button Click "
        ...
        If Not TextBox1.Text.Length = 0 Then
            Try
                If Me.CheckBox1.Checked = False And Me.CheckBox2.Checked = False Then
                    Shell("java.exe -jar bin\apktool.jar -f -o " & """" & "Output/decompile/" & Replace(My.Computer.FileSystem.GetFileInfo(TextBox1.Text).Name.ToString, My.Computer.FileSystem.GetFileInfo(TextBox1.Text).Extension.ToString, "") & """" & " d -p bin/Framework " & """" & TextBox1.Text & """", AppWinStyle.NormalFocus)
                End If

                If Me.CheckBox1.Checked = True And Me.CheckBox2.Checked = False Then
                    Shell("java.exe -jar bin\apktool.jar -f -o " & """" & "Output/decompile/" & Replace(My.Computer.FileSystem.GetFileInfo(TextBox1.Text).Name.ToString, My.Computer.FileSystem.GetFileInfo(TextBox1.Text).Extension.ToString, "") & """" & " d -p bin/Framework -r " & """" & TextBox1.Text & """", AppWinStyle.NormalFocus)
                End If

                If Me.CheckBox1.Checked = False And Me.CheckBox2.Checked = True Then
                    Shell("java.exe -jar bin\apktool.jar -f -o " & """" & "Output/decompile/" & Replace(My.Computer.FileSystem.GetFileInfo(TextBox1.Text).Name.ToString, My.Computer.FileSystem.GetFileInfo(TextBox1.Text).Extension.ToString, "") & """" & " d -p bin/Framework -s " & """" & TextBox1.Text & """", AppWinStyle.NormalFocus)
                End If

                If Me.CheckBox1.Checked = True And Me.CheckBox2.Checked = True Then
                    Shell("java.exe -jar bin\apktool.jar -f -o " & """" & "Output/decompile/" & Replace(My.Computer.FileSystem.GetFileInfo(TextBox1.Text).Name.ToString, My.Computer.FileSystem.GetFileInfo(TextBox1.Text).Extension.ToString, "") & """" & " d -p bin/Framework -r -s " & """" & TextBox1.Text & """", AppWinStyle.NormalFocus)
                End If
            Catch ex As Exception
                Me.RichTextBox2.Text = ex.ToString
            End Try
    ...
    Private Sub Button6_Click(sender As System.Object, e As System.EventArgs) Handles Button6.Click
        If Not TextBox2.Text.Length = 0 Then
            Try
                Shell("java -jar bin\apktool.jar -f b -o " & """" & TextBox2.Text & "-UnSign.apk" & """" & " -p bin\Framework " & " " & """" & TextBox2.Text & """", AppWinStyle.NormalFocus)
            Catch ex As Exception
                Me.RichTextBox2.Text = ex.ToString
            End Try
        Else
    ...
    Private Sub Button9_Click(sender As System.Object, e As System.EventArgs) Handles Button9.Click
        If Not TextBox1.Text.Length = 0 Then
            Try
                Shell("java -jar bin\signapk.jar bin\testkey.x509.pem bin\testkey.pk8 " & """" & TextBox1.Text & """" & " " & """" & TextBox1.Text & "-Sign.apk" & """", AppWinStyle.NormalFocus)
            Catch ex As Exception
                Me.RichTextBox2.Text = ex.ToString
            End Try
        Else
    ...
    Private Sub Button10_Click(sender As System.Object, e As System.EventArgs) Handles Button10.Click
        If Not TextBox1.Text.Length = 0 Then
            Try
                Shell("java -jar bin\signapk.jar bin\testkey.x509.pem bin\testkey.pk8 " & """" & TextBox1.Text & """" & " " & """" & TextBox1.Text & "-Sign.apk" & """", AppWinStyle.NormalFocus, True)
    ...
    Private Sub Button12_Click(sender As System.Object, e As System.EventArgs) Handles Button12.Click
        Dim EditMainf As New AndroidMainfest
    ...
    Private Sub Button15_Click(sender As System.Object, e As System.EventArgs) Handles Button15.Click
        If TextBox1.Text.Length Then
            Try
                ...
                If File.Exists(Application.StartupPath & "\bin\classes.dex") Then
                    Shell("bin\dex2jar\dex2jar.bat " & """" & Application.StartupPath & "\bin\classes.dex" & """", AppWinStyle.NormalFocus, True)
                End If
                If File.Exists(Application.StartupPath & "\bin\classes_dex2jar.jar") Then
                    File.Move(Application.StartupPath & "\bin\classes_dex2jar.jar", Replace(My.Computer.FileSystem.GetFileInfo(TextBox1.Text).FullName, ".apk", ".jar"))
                End If
                If File.Exists(Application.StartupPath & "\bin\classes.dex") Then
                    File.Delete(Application.StartupPath & "\bin\classes.dex")
                End If
        ...
        If Not TextBox7.Text.Length = 0 Then
            Try
                ...
                If CheckBox8.Checked = True Then
                    For Each FIS In FI
                        Shell("java -jar bin\signapk.jar bin\testkey.x509.pem bin\testkey.pk8 " & """" & TextBox7.Text & "\" & FIS.ToString & """" & " " & """" & TextBox7.Text & "\" & FIS.ToString & "-Sign.apk" & """", AppWinStyle.NormalFocus, True)
                    Next
                Else
                    For Each FIS In FI
                        Shell("java -jar bin\signapk.jar bin\testkey.x509.pem bin\testkey.pk8 " & """" & TextBox7.Text & "\" & FIS.ToString & """" & " " & """" & TextBox7.Text & "\" & FIS.ToString & "-Sign.apk" & """", AppWinStyle.NormalFocus)
                    Next
                End If
    ...
    Private Sub Button32_Click(sender As System.Object, e As System.EventArgs) Handles Button32.Click
        If TextBox3.Text.Length Then
            ...
            Try
                Shell("java.exe -jar bin\dex2jar\baksmali.jar -o " & """" & GetPath & """ " & """" & TextBox3.Text & """", AppWinStyle.NormalFocus)
            Catch ex As Exception
                Me.RichTextBox5.Text = ex.ToString
            End Try
        Else
    ...
    Private Sub Button33_Click(sender As System.Object, e As System.EventArgs) Handles Button33.Click
        If TextBox3.Text.Length Then
            Try
                Shell("bin\dex2jar\dex2jar.bat " & """" & TextBox3.Text & """", AppWinStyle.NormalFocus)
            Catch ex As Exception
                Me.RichTextBox5.Text = ex.ToString
            End Try
        Else
    ...
    Private Sub Button36_Click(sender As System.Object, e As System.EventArgs) Handles Button36.Click
        If TextBox5.Text.Length Then
            ...
            Try
                Shell("java.exe -jar bin\dex2jar\smali.jar -o " & """" & GetPath & """ " & """" & TextBox5.Text & """", AppWinStyle.NormalFocus)
            Catch ex As Exception
                Me.RichTextBox5.Text = ex.ToString
            End Try
        Else
        ...
        If CheckBox11.Checked = True Then
            Try
                For Each Dir As String In Directory.GetDirectories(TextBox9.Text)
                    ...
                    Shell("java -jar bin\apktool.jar -f b -o " & """" & "Output/Recompile/" & DI.Name & "-UnSign.apk" & """" & " -p bin\Framework " & " " & """" & Dir & """", AppWinStyle.NormalFocus, True)
                Next
            Catch ex As Exception
            End Try
        Else
            Try
                For Each Dir As String In Directory.GetDirectories(TextBox9.Text)
                    Dim DI As New DirectoryInfo(Dir)
                    Shell("java -jar bin\apktool.jar -f b -o " & """" & "Output/Recompile/" & DI.Name & "-UnSign.apk" & """" & " -p bin\Framework " & " " & """" & Dir & """", AppWinStyle.NormalFocus)
                Next
            Catch ex As Exception
            End Try
        End If
    ...
    Private Sub Button45_Click(sender As System.Object, e As System.EventArgs) Handles Button45.Click
        If Not My.Computer.Registry.GetValue("HKEY_CURRENT_USER\Software\UAA\Config", "JD", "") = "" Then
            Try
                Shell("""" & My.Computer.Registry.GetValue("HKEY_CURRENT_USER\Software\UAA\Config", "JD", "") & """", AppWinStyle.NormalFocus, False)
            Catch ex As Exception
            End Try
        End If
    End Sub
            ...
            Try
                ...
                If CheckBox10.Checked = True Then
                    If Me.CheckBox5.Checked = False And Me.CheckBox3.Checked = False Then
                        For Each FIS In FI
                            Shell("java.exe -jar bin\apktool.jar -f -o " & """" & "Output/decompile/" & Replace(FIS.ToString, My.Computer.FileSystem.GetFileInfo(FIS.ToString).Extension.ToString, "") & """" & " d -p bin/Framework " & """" & TextBox15.Text & "\" & FIS.ToString & """", AppWinStyle.NormalFocus, True)
                        Next
                    End If
                    ...
                    If Me.CheckBox5.Checked = False And Me.CheckBox3.Checked = True Then
                        For Each FIS In FI
                            Shell("java.exe -jar bin\apktool.jar -f -o " & """" & "Output/decompile/" & Replace(FIS.ToString, My.Computer.FileSystem.GetFileInfo(FIS.ToString).Extension.ToString, "") & """" & " d -p bin/Framework -s " & """" & TextBox15.Text & "\" & FIS.ToString & """", AppWinStyle.NormalFocus, True)
                        Next
                    End If

                    If Me.CheckBox5.Checked = True And Me.CheckBox3.Checked = True Then
                        For Each FIS In FI
                            Shell("java.exe -jar bin\apktool.jar -f -o " & """" & "Output/decompile/" & Replace(FIS.ToString, My.Computer.FileSystem.GetFileInfo(FIS.ToString).Extension.ToString, "") & """" & " d -p bin/Framework -r -s " & """" & TextBox15.Text & "\" & FIS.ToString & """", AppWinStyle.NormalFocus, True)
                        Next
                    End If
                Else
                    If Me.CheckBox5.Checked = False And Me.CheckBox3.Checked = False Then
                        For Each FIS In FI
                            Shell("java.exe -jar bin\apktool.jar -f -o " & """" & "Output/decompile/" & Replace(FIS.ToString, My.Computer.FileSystem.GetFileInfo(FIS.ToString).Extension.ToString, "") & """" & " d -p bin/Framework " & """" & TextBox15.Text & "\" & FIS.ToString & """", AppWinStyle.NormalFocus)
                        Next
                    End If

                    If Me.CheckBox5.Checked = True And Me.CheckBox3.Checked = False Then
                        For Each FIS In FI
                            Shell("java.exe -jar bin\apktool.jar -f  -o " & """" & "Output/decompile/" & Replace(FIS.ToString, My.Computer.FileSystem.GetFileInfo(FIS.ToString).Extension.ToString, "") & """" & " d -p bin/Framework -r " & """" & TextBox15.Text & "\" & FIS.ToString & """", AppWinStyle.NormalFocus)
                        Next
                    End If

                    If Me.CheckBox5.Checked = False And Me.CheckBox3.Checked = True Then
                        For Each FIS In FI
                            Shell("java.exe -jar bin\apktool.jar -f -o " & """" & "Output/decompile/" & Replace(FIS.ToString, My.Computer.FileSystem.GetFileInfo(FIS.ToString).Extension.ToString, "") & """" & " d -p bin/Framework -s " & """" & TextBox15.Text & "\" & FIS.ToString & """", AppWinStyle.NormalFocus)
                        Next
                    End If

                    If Me.CheckBox5.Checked = True And Me.CheckBox3.Checked = True Then
                        For Each FIS In FI
                            Shell("java.exe -jar bin\apktool.jar -f -o " & """" & "Output/decompile/" & Replace(FIS.ToString, My.Computer.FileSystem.GetFileInfo(FIS.ToString).Extension.ToString, "") & """" & " d -p bin/Framework -r -s " & """" & TextBox15.Text & "\" & FIS.ToString & """", AppWinStyle.NormalFocus)
                        Next
                    End If
                End If
    ...
    Private Sub Button48_Click(sender As System.Object, e As System.EventArgs) Handles Button48.Click
        If TextBox16.Text.Length Then
            Try
                Shell("java -jar bin\apktool.jar if -p bin\Framework " & """" & TextBox16.Text & """", AppWinStyle.NormalFocus)
            Catch ex As Exception
                MsgBox(ex.ToString, MsgBoxStyle.OkOnly, "error")
            End Try
        Else
    ...
    Private Sub Button50_Click(sender As System.Object, e As System.EventArgs) Handles Button50.Click
        MsgBox("7z : Igor Pavlov" & vbCrLf & "Apktool : Ryszard Wisniewski, Connor Tumbleson" & vbCrLf & "ApkShellext2 : kkguo" & vbCrLf & "baksmali / smali : Ben Gruver" & vbCrLf & "oat2dex : Softdx" & vbCrLf & "dex2jar : Bob Pan" & vbCrLf & "etc.", MsgBoxStyle.OkOnly, "Credits")
    End Sub
    ...
    Private Sub Button52_Click(sender As System.Object, e As System.EventArgs) Handles Button52.Click
        If TextBox17.Text.Length Then
            Try
                Shell("java -jar bin\apktool.jar if -p bin\Framework " & """" & TextBox17.Text & """", AppWinStyle.NormalFocus)
            Catch ex As Exception
                MsgBox(ex.ToString, MsgBoxStyle.OkOnly, "error")
            End Try
        Else
    ...
    Private Sub Button53_Click(sender As System.Object, e As System.EventArgs) Handles Button53.Click
        With OpenFileDialog1
            .FileName = ""
            .Title = "Select jd-gui.exe"
            .Filter = "Java Decompiler|jd-gui.exe"
            .ShowDialog()
            If Not .FileName.Length = 0 Then
                                ...
                                Try
                                    ...
                                    If File.Exists(My.Computer.FileSystem.SpecialDirectories.Temp & "\NextGenerationApktool.apk") = True Then
                                        ...
                                        If CheckBox4.Checked = True Then
                                            ...
                                            End If
                                        End If
                                        Shell("java -jar bin\apktool.jar -f -o " & """" & My.Computer.FileSystem.SpecialDirectories.Temp & "\NextGenerationApktool.apk" & """" & " b -p bin\Framework " & " " & """" & My.Computer.FileSystem.SpecialDirectories.Temp & "\NextGenerationApktool" & """", AppWinStyle.NormalFocus, True)
                                        Shell("java -jar bin\signapk.jar bin\testkey.x509.pem bin\testkey.pk8 " & """" & My.Computer.FileSystem.SpecialDirectories.Temp & "\NextGenerationApktool.apk" & """" & " " & """" & My.Computer.FileSystem.SpecialDirectories.Temp & "\NextGenerationApktool-Sign.apk" & """", AppWinStyle.NormalFocus, True)
                ...
                If Not TextBox26.Text.Length = 0 Then
                    Try
                        ...
                        If CheckBox12.Checked = True Then
                            For Each FIS In FI
                                Shell("java.exe -jar bin\dex2jar\baksmali.jar -d " & """" & TextBox28.Text & """" & " -o " & """" & TextBox26.Text & "\" & Replace(FIS.ToString, My.Computer.FileSystem.GetFileInfo(FIS.ToString).Extension, "") & """" & " -x " & """" & TextBox27.Text & "\" & FIS.ToString & """", AppWinStyle.NormalFocus, True)
                            Next
                        Else
                            For Each FIS In FI
                                Shell("java.exe -jar bin\dex2jar\baksmali.jar -d " & """" & TextBox28.Text & """" & " -o " & """" & TextBox26.Text & "\" & Replace(FIS.ToString, My.Computer.FileSystem.GetFileInfo(FIS.ToString).Extension, "") & """" & " -x " & """" & TextBox27.Text & "\" & FIS.ToString & """", AppWinStyle.NormalFocus, False)
                            Next
                        End If
                    Catch ex As Exception
                    End Try
            ...
            Try
                If Not My.Computer.Registry.GetValue("HKEY_CURRENT_USER\Software\UAA\Config", "AI", "") = "1" Then
                    If Environment.Is64BitOperatingSystem = False Then
                        Shell(WinDir & "\Microsoft.NET\Framework\v4.0.30319\RegAsm.exe" & " /codebase " & """" & Application.StartupPath & "\bin\apkshellext2.dll" & """", AppWinStyle.Hide, False)
                    Else
                        Shell(WinDir & "\Microsoft.NET\Framework64\v4.0.30319\RegAsm.exe" & " /codebase" & """" & Application.StartupPath & "\bin\apkshellext2.dll" & """", AppWinStyle.Hide, False)
                    End If
        ...
        Else
            Try
                If My.Computer.Registry.GetValue("HKEY_CURRENT_USER\Software\UAA\Config", "AI", "") = "1" Then
                    ...
                    Shell("TASKKILL /F /IM explorer.exe", AppWinStyle.Hide, True)
                    If Environment.Is64BitOperatingSystem = False Then
                        Shell(WinDir & "\Microsoft.NET\Framework\v4.0.30319\RegAsm.exe" & " /unregister " & """" & Application.StartupPath & "\bin\apkshellext2.dll" & """", AppWinStyle.Hide, False)
                    Else
                        Shell(WinDir & "\Microsoft.NET\Framework64\v4.0.30319\RegAsm.exe" & " /unregister " & """" & Application.StartupPath & "\bin\apkshellext2.dll" & """", AppWinStyle.Hide, False)
                    End If
                    Shell("explorer.exe", AppWinStyle.Hide, False)
